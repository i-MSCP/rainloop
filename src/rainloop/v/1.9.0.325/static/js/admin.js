...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! bootstrap */ 72)(__webpack_require__(/*! App/Admin */ 23));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			DomainStore = __webpack_require__(/*! Stores/Admin/Domain */ 65),
			PluginStore = __webpack_require__(/*! Stores/Admin/Plugin */ 66),
			LicenseStore = __webpack_require__(/*! Stores/Admin/License */ 142),
			PackageStore = __webpack_require__(/*! Stores/Admin/Package */ 88),
			CoreStore = __webpack_require__(/*! Stores/Admin/Core */ 87),
		...
		AdminApp.prototype.bootstart = function ()
		{
			...
			__webpack_require__(/*! Stores/Admin/Capa */ 47).populate();
			...
			else
			{
				...
				{
					kn.startScreens([
						__webpack_require__(/*! Screen/Admin/Settings */ 117)
					]);
				}
				else
				{
					kn.startScreens([
						__webpack_require__(/*! Screen/Admin/Login */ 116)
					]);
				}
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			CapaAdminStore = __webpack_require__(/*! Stores/Admin/Capa */ 47),
		...
		DomainPopupView.prototype.onDomainCreateOrSaveResponse = function (sResult, oData)
		{
			...
			if (Enums.StorageResultType.Success === sResult && oData)
			{
				if (oData.Result)
				{
					__webpack_require__(/*! App/Admin */ 23).reloadDomainList();
					this.closeCommand();
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! App/Admin */ 23).setWindowTitle('');
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractSettings = __webpack_require__(/*! Screen/AbstractSettings */ 64)
		;
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/General */ 126),
			...
			if (true)
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Branding */ 123),
			...
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Contacts */ 124),
				'AdminSettingsContacts', 'TABS_LABELS/LABEL_CONTACTS_NAME', 'contacts');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Domains */ 125),
				'AdminSettingsDomains', 'TABS_LABELS/LABEL_DOMAINS_NAME', 'domains');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Security */ 129),
				'AdminSettingsSecurity', 'TABS_LABELS/LABEL_SECURITY_NAME', 'security');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Social */ 130),
				'AdminSettingsSocial', 'TABS_LABELS/LABEL_INTEGRATION_NAME', 'integrations');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Plugins */ 128),
			...
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/About */ 122),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AboutAdminSettings.prototype.onBuild = function ()
		{
			...
			{
				__webpack_require__(/*! App/Admin */ 23).reloadCoreData();
			}
		};
		...
		AboutAdminSettings.prototype.updateCoreData = function ()
		{
			...
			{
				__webpack_require__(/*! App/Admin */ 23).updateCoreData();
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Domain */ 92));
		};
		...
		DomainsAdminSettings.prototype.onDomainLoadRequest = function (sResult, oData)
		{
			if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Domain */ 92), [oData.Result]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		PluginsAdminSettings.prototype.onShow = function ()
		{
			...
			__webpack_require__(/*! App/Admin */ 23).reloadPluginList();
		};
			...
			this.submitCommand = Utils.createCommand(this, function () {
				...
				Remote.adminLogin(_.bind(function (sResult, oData) {
					...
					if (Enums.StorageResultType.Success === sResult && oData && 'AdminLogin' === oData.Action)
					{
						if (oData.Result)
						{
							__webpack_require__(/*! App/Admin */ 23).loginAndLogoutReload(true);
						}
	...
	(function () {
		...
		function PaneSettingsAdminView()
		{
			...
			this.adminManLoading = ko.computed(function () {
				return '000' !== [
					__webpack_require__(/*! Stores/Admin/Domain */ 65).domains.loading() ? '1' : '0',
					__webpack_require__(/*! Stores/Admin/Plugin */ 66).plugins.loading() ? '1' : '0',
					__webpack_require__(/*! Stores/Admin/Package */ 88).packages.loading() ? '1' : '0'
				].join('');
			}, this);
		...
		PaneSettingsAdminView.prototype.logoutClick = function ()
		{
			Remote.adminLogout(function () {
				__webpack_require__(/*! App/Admin */ 23).loginAndLogoutReload(true, true);
			});
		};
