...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Mime = __webpack_require__(/*! Common/Mime */ 52),
		...
		Utils.windowPopupKnockout = function (oViewModel, sTemplateID, sTitle, fCallback)
		{
			...
			window[sFunc] = function () {
				...
				if (oWin && oWin.document.body && oTemplate && oTemplate[0])
				{
					...
					__webpack_require__(/*! Common/Translator */ 7).i18nToNodes(oBody);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (ko) {
		...
		var
			...
			_ = __webpack_require__(/*! _ */ 2),
			$ = __webpack_require__(/*! $ */ 12),
			Opentip = __webpack_require__(/*! Opentip */ 61),
		...
		ko.bindingHandlers.editor = {
			'init': function (oElement, fValueAccessor) {
				...
				var
					...
					HtmlEditor = __webpack_require__(/*! Common/HtmlEditor */ 39)
				;
		...
		ko.bindingHandlers.tooltip = {
				...
				if (!Globals.bMobileDevice || bMobile)
				{
					...
					if (bi18n)
					{
						...
						Globals.dropdownVisibility.subscribe(function () {
							if (oElement && oElement.__opentip)
							{
								oElement.__opentip.setContent(__webpack_require__(/*! Common/Translator */ 7).i18n(sValue));
							}
						});
					}
					else
			...
			'update': function (oElement, fValueAccessor) {
				...
				if ((!Globals.bMobileDevice || bMobile) && oElement.__opentip)
				{
					...
					{
						oElement.__opentip.setContent(
							bi18n ? __webpack_require__(/*! Common/Translator */ 7).i18n(sValue) : sValue);
						oElement.__opentip.activate();
					}
					else
					{
	...
	//				});
		...
		ko.bindingHandlers.moment = {
			'init': function (oElement, fValueAccessor) {
				__webpack_require__(/*! Common/Momentor */ 22).momentToNode(
		...
		ko.bindingHandlers.i18nInit = {
			'init': function (oElement) {
				__webpack_require__(/*! Common/Translator */ 7).i18nToNodes(oElement);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			crossroads = __webpack_require__(/*! crossroads */ 46),

			Globals = __webpack_require__(/*! Common/Globals */ 8),
			Plugins = __webpack_require__(/*! Common/Plugins */ 18),
			Utils = __webpack_require__(/*! Common/Utils */ 1)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Tinycon = __webpack_require__(/*! Tinycon */ 167),
			...
			Translator = __webpack_require__(/*! Common/Translator */ 7),
			Momentor = __webpack_require__(/*! Common/Momentor */ 22),
			...
			IdentityStore = __webpack_require__(/*! Stores/User/Identity */ 68),
			TemplateStore = __webpack_require__(/*! Stores/User/Template */ 91),
			...
			ContactStore = __webpack_require__(/*! Stores/User/Contact */ 48),
			...
			EmailModel = __webpack_require__(/*! Model/Email */ 29),
			AccountModel = __webpack_require__(/*! Model/Account */ 104),
			IdentityModel = __webpack_require__(/*! Model/Identity */ 110),
			TemplateModel = __webpack_require__(/*! Model/Template */ 113),
			OpenPgpKeyModel = __webpack_require__(/*! Model/OpenPgpKey */ 112),

			AbstractApp = __webpack_require__(/*! App/Abstract */ 50)
		;
		...
		AppUser.prototype.deleteMessagesFromFolder = function (iDeleteType, sFromFolderFullNameRaw, aUidForRemove, bUseFolder)
		{
			...
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 49), [nSetSystemFoldersNotification]);
			}
			...
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/Ask */ 44), [Translator.i18n('POPUPS_ASK/DESC_WANT_DELETE_MESSAGES'), function () {
	...
	//		});
		...
		AppUser.prototype.quota = function ()
		{
			Remote.quota(function (sResult, oData) {
				...
				{
					__webpack_require__(/*! Stores/User/Quota */ 90).populateData(
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/TwoFactorConfiguration */ 98), [true]);
		};

		AppUser.prototype.bootstartWelcomePopup = function (sUrl)
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/WelcomePage */ 154), [sUrl]);
		};
		...
		AppUser.prototype.bootstartLoginScreen = function ()
		{
			...
			{
				kn.startScreens([
					__webpack_require__(/*! Screen/User/Login */ 119)
				]);
		...
		AppUser.prototype.bootstart = function ()
		{
			...
			__webpack_require__(/*! Stores/User/App */ 20).populate();
			__webpack_require__(/*! Stores/User/Settings */ 27).populate();
			__webpack_require__(/*! Stores/User/Notification */ 69).populate();
			__webpack_require__(/*! Stores/User/Account */ 32).populate();
			__webpack_require__(/*! Stores/User/Contact */ 48).populate();

			var
				self = this,
				$LAB = __webpack_require__(/*! $LAB */ 164),
	...
	//require.ensure([], function() { // require code splitting
					...
					self.foldersReload(_.bind(function (bValue) {
						...
						if (bValue)
						{
							...
							kn.startScreens([
								__webpack_require__(/*! Screen/User/MailBox */ 120),
								__webpack_require__(/*! Screen/User/Settings */ 121),
								__webpack_require__(/*! Screen/User/About */ 118)
							]);
	...
	(function () {
		...
		Translator.prototype.reloadData = function ()
		{
			if (window['rainloopI18N'])
			{
				...
				__webpack_require__(/*! Common/Momentor */ 22).reload();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Utils = __webpack_require__(/*! Common/Utils */ 1),
			Consts = __webpack_require__(/*! Common/Consts */ 15),
			Base64 = __webpack_require__(/*! Common/Base64 */ 101),
			...
			AppStore = __webpack_require__(/*! Stores/User/App */ 20),
			SettingsStore = __webpack_require__(/*! Stores/User/Settings */ 27),

			AbstractAjaxRemote = __webpack_require__(/*! Remote/AbstractAjax */ 63)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AppStore = __webpack_require__(/*! Stores/App */ 67)
		;
	...
	(function () {
		...
		FolderUserStore.prototype.getNextFolderNames = function ()
		{
			var
				aResult = [],
				iLimit = 5,
				iUtc = __webpack_require__(/*! Common/Momentor */ 22).momentNowUnix(),
				iTimeout = iUtc - 60 * 5,
				aTimeouts = [],
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			$ = __webpack_require__(/*! $ */ 12),
			_ = __webpack_require__(/*! _ */ 2),
			moment = __webpack_require__(/*! moment */ 80),
				...
				viewModel: {
					createViewModel: function(oParams, oComponentInfo) {
						...
						if (oComponentInfo.element)
						{
							...
							__webpack_require__(/*! Common/Translator */ 7).i18nToNodes(oParams.element);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			MessageModel = __webpack_require__(/*! Model/Message */ 111),
			MessageHelper = __webpack_require__(/*! Helper/Message */ 83)
		;
			...
			if (Cache.getFolderInboxName() === sFolder && Utils.isNormal(sUidNext) && sUidNext !== '')
			{
				if (Utils.isArray(aNewMessages) && 0 < aNewMessages.length)
				{
					var
						...
						NotificationStore = __webpack_require__(/*! Stores/User/Notification */ 69)
					;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			ComposeAttachmentModel = __webpack_require__(/*! Model/ComposeAttachment */ 105),
		...
		function ComposePopupView()
		{
			...
			this.sendCommand = Utils.createCommand(this, function () {
				...
				if (!this.emptyToError() && !this.attachmentsInErrorError() && !this.attachmentsInProcessError())
				{
					...
					if ('' === sSentFolder)
					{
						kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 49), [Enums.SetSystemFoldersNotification.Sent]);
					}
					else
					{
			...
			this.saveCommand = Utils.createCommand(this, function () {
				...
				{
					kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 49), [Enums.SetSystemFoldersNotification.Draft]);
				}
				else
				{
			...
			this.contactsCommand = Utils.createCommand(this, function () {
				...
				if (this.allowContacts)
				{
					...
					_.delay(function () {
						kn.showScreenPopup(__webpack_require__(/*! View/Popup/Contacts */ 71),
	...
	//}, 1000);
			...
			aToEmails, aCcEmails, aBccEmails, sCustomSubject, sCustomPlainText)
		{
			...
			if (AppStore.composeInEdit())
			{
				...
				{
					kn.showScreenPopup(__webpack_require__(/*! View/Popup/Ask */ 44), [Translator.i18n('COMPOSE/DISCARD_UNSAVED_DATA'), function () {
		...
		ComposePopupView.prototype.tryToClosePopup = function ()
		{
			var
				self = this,
				PopupsAskViewModel = __webpack_require__(/*! View/Popup/Ask */ 44)
			;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractComponent = __webpack_require__(/*! Component/Abstract */ 28)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstracCheckbox = __webpack_require__(/*! Component/AbstracCheckbox */ 40)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	//		SettingsStore = require('Stores/User/Settings'),
			...
			PromisesPopulator = __webpack_require__(/*! Promises/User/Populator */ 115),
			AbstractAjaxPromises = __webpack_require__(/*! Promises/AbstractAjax */ 114)
		;
		...
		function ClientStorage()
		{
			var
				NextStorageDriver = __webpack_require__(/*! _ */ 2).find([
					__webpack_require__(/*! Common/ClientStorageDriver/LocalStorage */ 103),
					__webpack_require__(/*! Common/ClientStorageDriver/Cookie */ 102)
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractBoot = __webpack_require__(/*! Knoin/AbstractBoot */ 62)
		;
	...
	//		});
		...
		AbstractApp.prototype.bootstart = function ()
		{
			...
			ko.components.register('Select', __webpack_require__(/*! Component/Select */ 59));
			ko.components.register('TextArea', __webpack_require__(/*! Component/TextArea */ 60));
			ko.components.register('Radio', __webpack_require__(/*! Component/Radio */ 56));

			ko.components.register('x-script', __webpack_require__(/*! Component/Script */ 58));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstracRadio = __webpack_require__(/*! Component/AbstracRadio */ 53)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Enums = __webpack_require__(/*! Common/Enums */ 4),
			Audio = __webpack_require__(/*! Common/Audio */ 51),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			EmailModel = __webpack_require__(/*! Model/Email */ 29),
			ContactModel = __webpack_require__(/*! Model/Contact */ 106),
			ContactPropertyModel = __webpack_require__(/*! Model/ContactProperty */ 107),
		...
		function ContactsPopupView()
		{
			...
			this.newMessageCommand = Utils.createCommand(this, function () {
				...
				if (Utils.isNonEmptyArray(aE))
				{
					...
					kn.hideScreenPopup(__webpack_require__(/*! View/Popup/Contacts */ 71));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FilterConditionModel = __webpack_require__(/*! Model/FilterCondition */ 108),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FilterStore = __webpack_require__(/*! Stores/User/Filter */ 89),
			FolderStore = __webpack_require__(/*! Stores/User/Folder */ 21),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AbstractSystemDropDownUserView.prototype.addAccountClick = function ()
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 70));
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AttachmentModel = __webpack_require__(/*! Model/Attachment */ 84),
	...
	//		}
		...
		MessageModel.prototype.getDataForWindowPopup = function ()
		{
			return {
				...
				'popupDate': __webpack_require__(/*! Common/Momentor */ 22).format(this.dateTimeStampInUTC(), 'FULL'),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractBasicPromises = __webpack_require__(/*! Promises/AbstractBasic */ 86)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FolderModel = __webpack_require__(/*! Model/Folder */ 109),
	...
	(function () {
		...
		function AboutUserScreen()
		{
			AbstractScreen.call(this, 'about', [
				__webpack_require__(/*! View/User/About */ 155)
			]);
		}
	...
	(function () {
		...
		function LoginUserScreen()
		{
			AbstractScreen.call(this, 'login', [
				__webpack_require__(/*! View/User/Login */ 156)
			]);
		}
	...
	(function () {
		...
		function MailBoxUserScreen()
		{
			AbstractScreen.call(this, 'mailbox', [
				__webpack_require__(/*! View/User/MailBox/SystemDropDown */ 160),
				__webpack_require__(/*! View/User/MailBox/FolderList */ 157),
				__webpack_require__(/*! View/User/MailBox/MessageList */ 158),
				__webpack_require__(/*! View/User/MailBox/MessageView */ 159)
			]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractSettingsScreen = __webpack_require__(/*! Screen/AbstractSettings */ 64)
		;
		...
		function SettingsUserScreen()
		{
			AbstractSettingsScreen.call(this, [
				__webpack_require__(/*! View/User/Settings/SystemDropDown */ 163),
				__webpack_require__(/*! View/User/Settings/Menu */ 161),
				__webpack_require__(/*! View/User/Settings/Pane */ 162)
			]);
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/General */ 136),
				'SettingsGeneral', 'SETTINGS_LABELS/LABEL_GENERAL_NAME', 'general', true);

			if (AppStore.contactsIsAllowed())
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Contacts */ 133),
					'SettingsContacts', 'SETTINGS_LABELS/LABEL_CONTACTS_NAME', 'contacts');
			}

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Accounts */ 131), 'SettingsAccounts',
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Filters */ 134),
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Security */ 138),
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Social */ 139),
					'SettingsSocial', 'SETTINGS_LABELS/LABEL_SOCIAL_NAME', 'social');
			}

			if (Settings.settingsGet('ChangePasswordIsAllowed'))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/ChangePassword */ 132),
					'SettingsChangePassword', 'SETTINGS_LABELS/LABEL_CHANGE_PASSWORD_NAME', 'change-password');
			}

			if (Settings.capa(Enums.Capa.Templates))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Templates */ 140),
					'SettingsTemplates', 'SETTINGS_LABELS/LABEL_TEMPLATES_NAME', 'templates');
			}

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Folders */ 135),
				'SettingsFolders', 'SETTINGS_LABELS/LABEL_FOLDERS_NAME', 'folders');

			if (Settings.capa(Enums.Capa.Themes))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Themes */ 141),
					'SettingsThemes', 'SETTINGS_LABELS/LABEL_THEMES_NAME', 'themes');
			}

			if (Settings.capa(Enums.Capa.OpenPGP))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/OpenPgp */ 137),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AccountsUserSettings.prototype.editAccount = function (oAccountItem)
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 70), [oAccountItem]);
			}
		};

		AccountsUserSettings.prototype.addNewIdentity = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 95));
		};

		AccountsUserSettings.prototype.editIdentity = function (oIdentity)
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 95), [oIdentity]);
		};
	...
	(function () {
		...
		ChangePasswordUserSettings.prototype.onChangePasswordResponse = function (sResult, oData)
		{
			...
			if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
			{
				...
				__webpack_require__(/*! App/User */ 6).setClientSideToken(oData.Result);
			}
			else
			{
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		FiltersUserSettings.prototype.updateList = function ()
		{
			var
				self = this,
				FilterModel = __webpack_require__(/*! Model/Filter */ 85)
			;
		...
		FiltersUserSettings.prototype.addFilter = function ()
		{
			...
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(
				__webpack_require__(/*! View/Popup/Filter */ 93), [oNew, function  () {
		...
		FiltersUserSettings.prototype.editFilter = function (oEdit)
		{
			...
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(
				__webpack_require__(/*! View/Popup/Filter */ 93), [oCloned, function  () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/FolderCreate */ 94));
		};

		FoldersUserSettings.prototype.systemFolder = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 49));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AdvancedSearchPopupView.prototype.buildSearchString = function ()
		{
			...
			{
				aResult.push('date:' + __webpack_require__(/*! Common/Momentor */ 22).searchSubtractFormatDateHelper(this.selectedDateValue()) + '/');
			}
						...
						Remote.login(_.bind(function (sResult, oData) {
							...
							if (Enums.StorageResultType.Success === sResult && oData && 'Login' === oData.Action)
							{
								if (oData.Result)
								{
									...
									{
										__webpack_require__(/*! App/User */ 6).loginAndLogoutReload(false);
									}
								}
								else if (oData.ErrorCode)
								{
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderCreate */ 94));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AppStore = __webpack_require__(/*! Stores/User/App */ 20),
			QuotaStore = __webpack_require__(/*! Stores/User/Quota */ 90),
			SettingsStore = __webpack_require__(/*! Stores/User/Settings */ 27),
			FolderStore = __webpack_require__(/*! Stores/User/Folder */ 21),
			MessageStore = __webpack_require__(/*! Stores/User/Message */ 30),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			PhotoSwipe = __webpack_require__(/*! PhotoSwipe */ 165),
			PhotoSwipeUI_Default = __webpack_require__(/*! PhotoSwipeUI_Default */ 166),
	...
	//							'getThumbBoundsFn': fThumbBoundsFn,
			...
			oDom
				.on('click', 'a', function (oEvent) {
					...
					return !(!!oEvent && 3 !== oEvent['which'] && Utils.mailToHelper($(this).attr('href'), __webpack_require__(/*! View/Popup/Compose */ 31)));
				})
				...
				.on('click', '.thread-list .flagParent', function () {
					...
					{
						__webpack_require__(/*! App/User */ 6).messageListAction(
		...
		MessageViewMailBoxUserView.prototype.downloadAsZip = function ()
		{
			...
			if (0 < aHashes.length)
			{
				Promises.attachmentsActions('Zip', aHashes, this.downloadAsZipLoading).then(function (oResult) {
					...
					{
						__webpack_require__(/*! App/User */ 6).download(
